...
def update(request, id):
    ...
    if request.POST:
        ...
        review_record.DefectTarget = data['DefectTarget']
        review_record.DefectType = data['DefectType']
        review_record.DefectQualifier = data['DefectQualifier']
        review_record.DefectSource = data['DefectSource']
        review_record.DefectAge = data['DefectAge']
