...
from workflow.VobConfig.models import dev_status

class CCLockFlowForm(forms.ModelForm):
    main_mr_id = forms.CharField(widget=forms.widgets.TextInput(\
        attrs={}))
    vob_branch_2_mr_id = forms.CharField(widget=forms.widgets.TextInput(\
        attrs={}))
    vob_branch_3_mr_id = forms.CharField(widget=forms.widgets.TextInput(\
        attrs={}))
    vob_branch_4_mr_id = forms.CharField(widget=forms.widgets.TextInput(\
        attrs={}))
    vob_branch_5_mr_id = forms.CharField(widget=forms.widgets.TextInput(\
        attrs={}))
    vob_branch_6_mr_id = forms.CharField(widget=forms.widgets.TextInput(\
        attrs={}))
