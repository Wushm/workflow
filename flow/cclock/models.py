...
class CCLockFlow(models.Model):
    ...
    vob_branch_1 = models.CharField(max_length=100, choices=get_branch_choices())#分支
    vob_branch_2 = models.CharField(blank=True, null=True, max_length=100, choices=get_branch_choices())#分支
    vob_branch_3 = models.CharField(blank=True, null=True, max_length=100, choices=get_branch_choices())#分支
    vob_branch_4 = models.CharField(blank=True, null=True, max_length=100, choices=get_branch_choices())#分支
    vob_branch_5 = models.CharField(blank=True, null=True, max_length=100, choices=get_branch_choices())#分支
    vob_branch_6 = models.CharField(blank=True, null=True, max_length=100, choices=get_branch_choices())#分支
